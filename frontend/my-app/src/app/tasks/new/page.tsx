            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl text-sm outline-none transition-all bg-white"
                  style={{
                    border: `1.5px solid ${deadline ? C.accent + "55" : "#E2E8F0"}`,
                    color: deadline ? C.primary : C.neutral,
                  }}
                  onFocus={e => { e.currentTarget.style.borderColor = C.accent; e.currentTarget.style.boxShadow = `0 0 0 3px ${C.accent}18`; }}
                  onBlur={e  => { e.currentTarget.style.borderColor = deadline ? C.accent + "55" : "#E2E8F0"; e.currentTarget.style.boxShadow = "none"; }}
                />
              </div>
            </div>
